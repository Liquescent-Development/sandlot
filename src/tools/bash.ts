 ...
 */
export function createSandlotBashOperations(dependencies: BashDependencies): BashOperations {
...
export function createSandlotUserBashOperations(dependencies: BashDependencies): BashOperations {
 ...
 */
export function createSandlotBashTool(dependencies: BashDependencies): ReturnType<typeof createBashToolDefinition> {
